...
categories = [
    ...
    (
        'Масик',
        'Тип психологически зрелого мужчины, который имеет правильные убеждения, постоянную работу, готов брать на '
        'себя ответственность.',
        settings.photo.masik),
    (
        'Тюбик',
        'Мужчина хлипкого телосложения, не желающих брать ответственность, часто впадающих в истерику, с подавленным '
        'настроением и думающих только о своих чувствах.',
